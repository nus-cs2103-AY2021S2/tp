...
public class ArgumentTokenizer {
    ...
    /**
     * Tokenizes an arguments string and returns a {@code List<String>} object that represents the arguments
     * in the argument string. Command word and each argument is separated by whitespaces.
     *
     * @param argsString Arguments string of the form: {@code preamble value value ...}
     * @return {@code List<String>} object that represents the arguments
     */
    public static List<String> tokenizeWithoutPrefix(String argsString) {
