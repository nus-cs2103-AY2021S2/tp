 ...
 */
public class UniqueExpiredTaskList implements Iterable<Task> {
    ...
    public void setTasks(UniqueExpiredTaskList replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof UniqueExpiredTaskList // instanceof handles nulls
                && internalList.equals(((UniqueExpiredTaskList) other).internalList));
    }
