 ...
 */
public class UniqueCompletedTaskList implements Iterable<Task> {
    ...
    public void setTasks(UniqueCompletedTaskList replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof UniqueCompletedTaskList // instanceof handles nulls
