...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        return new Task[]{
            new Task(new Name("Alex Yeoh"), new Description("2106 lab on threads"), new Email("alexyeoh@example.com"),
                    new Address("Blk 30 Geylang Street 29, #06-40"), new Date("2020-04-13 09:30"),
                    getTagSet("friends")),
            new Task(new Name("Bernice Yu"), new Description("2106 lab on threads"), new Email("berniceyu@example.com"),
            ...
            new Task(new Name("David Li"), new Description("2106 lab on threads"), new Email("lidavid@example.com"),
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Date("2020-04-13 09:30"),
                    getTagSet("family")),
            new Task(new Name("Irfan Ibrahim"), new Description("2106 lab on threads"), new Email("irfan@example.com"),
