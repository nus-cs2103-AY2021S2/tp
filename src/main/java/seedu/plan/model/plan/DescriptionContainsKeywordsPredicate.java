 ...
 */
public class DescriptionContainsKeywordsPredicate implements Predicate<Plan> {
    ...
    public boolean test(Plan plan) {
        return keywords.stream()
                .anyMatch(keyword -> StringUtil.containsWordIgnoreCase(plan.getDescription().toString(), keyword));
    }
