...
import seedu.plan.model.plan.UniquePlanList;
    ...
    private JsonModule[] readModuleInfo() throws IOException {
        ...
        try {
            ...
            FileUtil.writeToFile(filePath, "[\n"
                    ...
                    + " \"CS1010S\", \"CS1010X\", \"CS1010XCP\", \"CS1101S\"]\n"
                    + "  }, {\n" + "    \"moduleCode\": \"CS1101S\",\n"
                    + "    \"moduleTitle\": \"Programming Methodology\",\n"
                    + "    \"numMc\": \"4\",\n"
                    + "    \"availSems\": \"B\",\n"
                    ...
                    + "    \"availSems\": \"A | B\",\n"
                    + "    \"prereqs\": [],\n"
                    + "    \"preclusions\": [\"CS1010\", \"CS1010E\","
                    + " \"CS1010J\", \"CS1010X\", \"CS1010XCP\", \"CS1101S\"]\n"
                    + "  }, {\n" + "    \"moduleCode\": \"CS2030S\",\n"
                    + "    \"moduleTitle\": \"Programming Methodology II\",\n"
                    + "    \"numMc\": \"4\",\n"
                    + "    \"availSems\": \"B\",\n"
                    + "    \"prereqs\": [\"CS1010|CS1101S\"],\n"
                    + "    \"preclusions\": [\"CS2030\"]\n"
                    + "  }, {\n"
                    + "    \"moduleCode\": \"ST2334\",\n"
