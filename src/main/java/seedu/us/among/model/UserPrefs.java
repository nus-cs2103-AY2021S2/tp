...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path endpointListFilePath = Paths.get("data" , "imposter.json");
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && endpointListFilePath.equals(o.endpointListFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, endpointListFilePath);
    }
    ...
    public String toString() {
        ...
        sb.append("\nLocal data file location : " + endpointListFilePath);
        return sb.toString();
    }
