...
public class SampleDataUtil {
    public static Endpoint[] getSampleEndpoint() {
        return new Endpoint[] {
            ...
            new Endpoint(new Method("GET"),
                    new Address("https://the-one-api.dev/v2/book"),
                    getHeaderSet(),
            ...
            new Endpoint(new Method("PUT"),
                    new Address("https://reqres.in/api/users/2"),
                    new Data("{\"name\": \"john tan\", \"job\": \"director\"}"),
                    getHeaderSet("\"Content-Type: application/json\""),
                    getTagSet("work"), new Response()),
            new Endpoint(new Method("PUT"),
                    new Address("https://jsonplaceholder.typicode.com/posts/1"),
                    new Data("{\"id\": \"1\", \"title\": \"hello\", \"body\": \"there\", \"userId\": \"1\"}"),
                    getHeaderSet("\"Content-Type: application/json\""),
                    getTagSet("mockend"), new Response()),
            new Endpoint(new Method("DELETE"),
                    new Address("https://reqres.in/api/users/2"),
                    getHeaderSet(),
                    getTagSet("work"), new Response()),
            new Endpoint(new Method("DELETE"),
                    ...
                    getHeaderSet(),
                    getTagSet("mockend"), new Response()),
            new Endpoint(new Method("PATCH"),
                    new Address("https://reqres.in/api/users/2"),
                    new Data("{\"name\": \"john smith\", \"job\": \"manager\"}"),
                    getHeaderSet("\"Content-Type: application/json\""),
                    getTagSet("work"), new Response()),
            new Endpoint(new Method("PATCH"),
                    new Address("https://jsonplaceholder.typicode.com/posts/1"),
                    new Data("{\"title\": \"hello\"}"),
                    getHeaderSet("\"Content-Type: application/json\""),
                    getTagSet("mockend"), new Response()),
            new Endpoint(new Method("HEAD"),
                    new Address("https://cat-fact.herokuapp.com/facts"),
                    getHeaderSet(),
                    getTagSet("cats", "animals"), new Response()),
            new Endpoint(new Method("HEAD"),
                    new Address("https://jsonplaceholder.typicode.com/posts/1"),
                    getHeaderSet(),
                    getTagSet("mockend"), new Response()),
