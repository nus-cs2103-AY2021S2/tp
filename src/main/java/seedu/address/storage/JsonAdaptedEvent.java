...
class JsonAdaptedEvent {
    ...
    public Event toModelType() throws IllegalValueException {
        if (date == null) {
            throw new IllegalValueException("date should not be null.");
        }
        ...
        if (time == null) {
            throw new IllegalValueException("time should not be null.");
        }
        ...
        if (isWeekly == null) {
            throw new IllegalValueException("isWeekly should not be null.");
        }
