...
public class SampleDataUtil {
    public static Student[] getSampleStudents() {
        ...
        berniceSessionList.add(new RecurringSession(new SessionDate("2021-01-01T12:00"),
            new Duration("120"),
            new Subject("Math"), new Fee("23.4"), new Interval("4"),
            new SessionDate("2021-01-21T12:00")));
