 ...
 * unique in terms of identity in the UniqueAppointmentList. However, the removal of an appointment uses
 * Appointment#equals(Object) so as to ensure that the appointment with exactly the same fields will be removed.
 * <p>
 * Supports a minimal set of list operations.
 *
 * @see Appointment#isSameAppointment(Appointment) (Appointment)
 */
