...
/**
 * Represents a Task's module in the address book.
 * Guarantees: immutable; is valid as declared in {@link #isValidModule(String)}
 */
public class Module {

    private static final String SPECIAL_CHARACTERS = "!#$%&'*+/=?`{|}~^.-";
    public static final String MESSAGE_CONSTRAINTS = "Modules should be of the format local-part@domain "
     ...
     *
     * @param module A valid module address.
     */
