...
public class Fee {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Format of fee input is incorrect or the given fee is " +
        "unacceptable (Only accepts value between 0 to 9999.99).";
