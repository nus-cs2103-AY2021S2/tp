...
public class ClearAssigneesCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Removes all assignees from the task identified by the index number used "
            + " in the displayed task list.\n"
            + "Parameters: INDEX (must be a positive integer)\n"
            + "Example: " + COMMAND_WORD + " 1";

    public static final String MESSAGE_CLEARED_ASSIGNEES_SUCCESS = "Removed all Assignees from Task: %1$s";
