...
/**
 * Edits the details of an existing plan in the description book.
 */
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_EDIT_PERSON_SUCCESS = "Edited Plan: %1$s";
    public static final String MESSAGE_NOT_EDITED = "At least one field to edit must be provided.";
    public static final String MESSAGE_DUPLICATE_PERSON = "This plan already exists in the description book.";
     ...
     * @param editPersonDescriptor details to edit the plan with
     */
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Plan editedPlan = createEditedPerson(planToEdit, editPersonDescriptor);

        /* TODO Check for duplicate plans
     ...
     */
    private static Plan createEditedPerson(Plan planToEdit, EditPersonDescriptor editPersonDescriptor) {
        assert planToEdit != null;

        Phone updatedPhone = editPersonDescriptor.getPhone().orElse(planToEdit.getPhone());
        Email updatedEmail = editPersonDescriptor.getEmail().orElse(planToEdit.getEmail());
        Description updatedDescription = editPersonDescriptor.getAddress().orElse(planToEdit.getDescription());
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(planToEdit.getTags());

        return new Plan(updatedPhone, updatedEmail, updatedDescription, updatedTags);
    }
