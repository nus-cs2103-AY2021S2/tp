...
/**
 * Edits the details of an existing flashcard in the answer book.
 */
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the flashcard identified "
            ...
            + PREFIX_QUESTION + "johndoe@example.com";

    public static final String MESSAGE_EDIT_FLASHCARD_SUCCESS = "Edited Flashcard: %1$s";
    public static final String MESSAGE_NOT_EDITED = "At least one field to edit must be provided.";
    public static final String MESSAGE_DUPLICATE_FLASHCARD = "This flashcard already exists in the answer book.";
