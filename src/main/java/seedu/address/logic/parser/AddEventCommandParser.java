...
public class AddEventCommandParser implements Parser<AddEventCommand> {
    ...
    public AddEventCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_DESCRIPTION, PREFIX_INTERVAL, PREFIX_REPEATABLE_DATE);

        if (!arePrefixesPresent(argMultimap, PREFIX_DESCRIPTION, PREFIX_INTERVAL, PREFIX_REPEATABLE_DATE)) {
