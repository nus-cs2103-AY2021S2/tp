 ...
 */
public class EditCommandParser implements Parser<UpdateContactCommand> {
    ...
    public UpdateContactCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, UpdateContactCommand.MESSAGE_USAGE),
                    pe);
        }
