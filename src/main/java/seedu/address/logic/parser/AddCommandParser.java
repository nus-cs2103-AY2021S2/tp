...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_DATEOFBIRTH, PREFIX_GENDER,
                        PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_BLOODTYPE, PREFIX_HEIGHT, PREFIX_WEIGHT, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_DATEOFBIRTH, PREFIX_GENDER, PREFIX_PHONE, PREFIX_EMAIL,
                PREFIX_ADDRESS, PREFIX_BLOODTYPE, PREFIX_HEIGHT, PREFIX_WEIGHT)
        ...
        Patient patient = new Patient(name, dateOfBirth, gender, phone, email, address,
                bloodType, height, weight, tagList);
