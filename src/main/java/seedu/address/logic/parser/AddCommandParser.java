...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_SIZE, PREFIX_EMAIL, PREFIX_DRESSCODE,
                        PREFIX_DESCRIPTION);

        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_DRESSCODE, PREFIX_SIZE, PREFIX_EMAIL)
        ...
        Person person = new Person(name, size, email, dresscode, descriptionList);
