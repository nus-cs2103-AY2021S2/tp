...
public class Messages {
    ...
    public static final String MESSAGE_SINGULAR_CUSTOMER_LISTED_OVERVIEW = "%1$d customer listed!";
    public static final String MESSAGE_NO_SUCH_NAME_IN_BOOK = "The customer name provided is invalid";
}
