...
public class Messages {
    ...
    public static final String MESSAGE_MISSING_OPTION = "No options provided provided: %1$s";
    public static final String MESSAGE_MISSING_OPTION_ARGS = "No arguements provided for option selected: ";
