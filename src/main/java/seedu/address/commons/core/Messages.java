...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PASSENGER_DISPLAYED_INDEX =
            "One of the passenger index provided is invalid";
    public static final String MESSAGE_INVALID_POOL_DISPLAYED_INDEX =
            "One of the pool index provided is invalid";
