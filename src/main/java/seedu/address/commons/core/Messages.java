...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_GENERAL_EVENT_DISPLAYED_INDEX = "The general index provided is invalid";
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW = "%1$d persons listed!";
    public static final String MESSAGE_MODULE_LISTED_OVERVIEW = "%1$d modules listed!";
    public static final String MESSAGE_EVENTS_LISTED_OVERVIEW = "%1$d events listed!";
    public static final String MESSAGE_INVALID_MODULE_TITLE = "The module title provided does not exist";
}
