...
public class StringUtil {
    ...
    public static boolean containsIgnoreCase(String sentence, String word) {
        ...
        return Arrays.stream(wordsInPreppedSentence)
                .anyMatch(preppedSentenceWord -> preppedSentenceWord.contains(preppedWord));
    }
     ...
     * e.g. -2, -1, 0, 1, 2, 3, ..., {@code Integer.MAX_VALUE} <br>
     * Will return false for any other non-null string input
     * e.g. empty string, "abc", "AAA", and " 2 " (untrimmed), "3 0" (contains whitespace), "1 a" (contains letters)
     *
     * @throws NullPointerException if {@code s} is null.
     */
