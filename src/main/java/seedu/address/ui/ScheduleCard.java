...
public class ScheduleCard extends UiPart<Region> {
    ...
    public ScheduleCard(Schedule schedule) {
        ...
        startDate.setText("from: " + schedule.getStartDate().format(DateTimeFormatter.ofPattern("E, dd MMM yyyy h:mm a")));
        endDate.setText("to: " + schedule.getEndDate().format(DateTimeFormatter.ofPattern("E, dd MMM yyyy h:mm a")));
