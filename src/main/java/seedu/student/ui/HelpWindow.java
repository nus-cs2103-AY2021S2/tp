...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String COMMAND_SUMMARY = " Here is a list of the commonly used commands for VAX@NUS" + DIVIDER
            ...
            + "\n\n Find a student with their appointment : find MATRICULATION_NUMBER"
