...
public class ListCommandCommand extends Command {
    ...
    public static final String SHOWING_LIST_COMMAND_MESSAGE =
        ...
        + AddDefinitionCommand.COMMAND_WORD + ", "
        + AddContentCommand.COMMAND_WORD + "\n\n"
        + "Note Command List (enter `listcommandn` for more details)\n"
        ...
        + "Contact Command List (enter `listcommandc` for more details)\n"
        ...
        + "UI Command List: (enter `listcommandu` for more details)\n"
