...
public class LogsCenter {
    ...
    private static final String LOG_FILE = "smartlib.log";
     ...
     *
     * @param config a config object specifying the custom log level
     */
     ...
     *
     * @param clazz class name of the Logger
     * @return a Logger with the given class name
     */
     ...
     *
     * @return the FileHandler for the log file
    ...
    /**
     * Creates a {@code ConsoleHandler} with the current log level.
     *
     * @return the ConsoleHandler with the current log level
     */
