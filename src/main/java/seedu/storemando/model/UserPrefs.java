...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path storeMandoFilePath = Paths.get("data", "storemando.json");
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setStoreMandoFilePath(newUserPrefs.getStoreMandoFilePath());
    }
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
            && storeMandoFilePath.equals(o.storeMandoFilePath);
    }
    ...
    public String toString() {
        ...
        sb.append("\nLocal data file location : " + storeMandoFilePath);
        return sb.toString();
    }
