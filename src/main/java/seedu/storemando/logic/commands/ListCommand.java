...
public class ListCommand extends Command {
    ...
    public static final String MESSAGE_SUCCESS_TAG_PREDICATE = "Listed all items with the following tag %s (if any).";
    public static final String MESSAGE_SUCCESS_LOCATION_PREDICATE = "Listed all items located in %s (if any).";
