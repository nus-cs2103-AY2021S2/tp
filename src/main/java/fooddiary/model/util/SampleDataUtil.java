...
public class SampleDataUtil {
    public static Entry[] getSampleEntries() {
        return new Entry[] {
            new Entry(new Name("KFC"), new Rating("3"), new Price("8"), new Review("too oily"),
                    new Address("3155 Commonwealth Ave W, #B1-32/33, Singapore 129588"),
                    getTagSet("FastFood")),
            new Entry(new Name("Frontier"), new Rating("4"), new Price("4"), new Review("cheap good food!"),
                    new Address("12 Science Drive 2, Singapore 117549"),
                    getTagSet("Others")),
            new Entry(new Name("Mcdonald"), new Rating("1"), new Price("7"),
                    new Review("Food sucks, not properly cooked."),
                    new Address("Blk 30 Geylang Street 29, #06-40"), getTagSet("FastFood")),
            new Entry(new Name("Ameens"), new Rating("5"), new Price("8"), new Review("Cheese fries is lit!!!"),
