 ...
 */
public class DeleteProgramCommandParserTest {

    private DeleteProgramCommandParser parser = new DeleteProgramCommandParser();

    @Test
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, String.valueOf(ID_ONE), new DeleteProgramCommand(ID_ONE));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteProgramCommand.MESSAGE_USAGE));
    }
}
