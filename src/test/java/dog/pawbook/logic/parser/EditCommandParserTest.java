...
import static dog.pawbook.testutil.TypicalIndexes.INDEX_THIRD_OWNER;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        Index targetIndex = INDEX_SECOND_OWNER;
    ...
    public void parse_someFieldsSpecified_success() {
        Index targetIndex = INDEX_FIRST_OWNER;
    ...
    public void parse_oneFieldSpecified_success() {
        // name
        Index targetIndex = INDEX_THIRD_OWNER;
