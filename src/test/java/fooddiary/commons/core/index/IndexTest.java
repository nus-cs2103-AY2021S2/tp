package fooddiary.commons.core.index;
...
public class IndexTest {
    ...
    public void equals() {
        ...
        assertTrue(fifthEntryIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthEntryIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthEntryIndex.equals(fifthEntryIndex));

        // null -> returns false
        assertFalse(fifthEntryIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthEntryIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthEntryIndex.equals(Index.fromOneBased(1)));
    }
}
