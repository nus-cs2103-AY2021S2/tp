...
public class AddOnCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + CommandTestUtil.REVIEW_DESC_AMY, MESSAGE_INVALID_FORMAT);

        // zero index
        assertParseFailure(parser, "0" + CommandTestUtil.REVIEW_DESC_AMY, MESSAGE_INVALID_FORMAT);
        ...
        assertParseFailure(parser, "1 some random string"
                + CommandTestUtil.REVIEW_DESC_AMY, MESSAGE_INVALID_FORMAT);
