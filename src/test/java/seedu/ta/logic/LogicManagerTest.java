...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTeachingAssistantStorage teachingAssistantStorage =
                new JsonTeachingAssistantStorage(temporaryFolder.resolve("teachingassistant.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(teachingAssistantStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonTeachingAssistantIoExceptionThrowingStub
        JsonTeachingAssistantStorage teachingAssistantStorage =
                new JsonTeachingAssistantIoExceptionThrowingStub(temporaryFolder
                        .resolve("ioExceptionTeachingAssistant.json"));
     ...
     */
    private static class JsonTeachingAssistantIoExceptionThrowingStub extends JsonTeachingAssistantStorage {
        private JsonTeachingAssistantIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }

        @Override
        public void saveTeachingAssistant(ReadOnlyTeachingAssistant teachingAssistant, Path filePath)
                throws IOException {
