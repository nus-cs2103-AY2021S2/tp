...
public class StorageManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonFlashcardBookStorage flashcardBookStorage = new JsonFlashcardBookStorage(getTempFilePath("ab"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(getTempFilePath("prefs"));
        storageManager = new StorageManager(flashcardBookStorage, userPrefsStorage);
    }
    ...
    //         * More extensive testing of UserPref saving/reading is done in {@link JsonFlashcardBookStorageTest} class.
    //         */
    ...
    public void getFlashcardBookFilePath() {
        assertNotNull(storageManager.getFlashcardBookFilePath());
    }
