...
public class JsonAdaptedEndpointTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEndpoint endpoint =
                new JsonAdaptedEndpoint(INVALID_NAME, VALID_PHONE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedEndpoint endpoint = new JsonAdaptedEndpoint(null, VALID_PHONE,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedEndpoint endpoint =
                new JsonAdaptedEndpoint(VALID_NAME, INVALID_PHONE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedEndpoint endpoint = new JsonAdaptedEndpoint(VALID_NAME, null,
                VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedEndpoint endpoint =
                new JsonAdaptedEndpoint(VALID_NAME, VALID_PHONE, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedEndpoint endpoint = new JsonAdaptedEndpoint(VALID_NAME, VALID_PHONE,
                null, VALID_TAGS);
        String expectedMessage = String.format(JsonAdaptedEndpoint.MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedEndpoint endpoint =
                new JsonAdaptedEndpoint(VALID_NAME, VALID_PHONE, VALID_ADDRESS, invalidTags);
