...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditEndpointDescriptorBuilder().withName(VALID_NAME_AMY)
                .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditEndpointDescriptorBuilder().withName(VALID_NAME_BOB)
     ...
     * - the API endpoint list, filtered endpoint list and selected endpoint in {@code actualModel} remain unchanged
     */
    ...
    /**
     * Updates {@code model}'s filtered list to show only the endpoint at the given {@code targetIndex} in the
     * {@code model}'s API endpoint list.
     */
