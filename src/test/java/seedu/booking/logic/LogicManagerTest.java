...
import static seedu.booking.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
import static seedu.booking.testutil.TypicalPersons.AMY;
...
import seedu.booking.storage.JsonBookingSystemStorage;
import seedu.booking.storage.JsonUserPrefsStorage;
import seedu.booking.storage.StorageManager;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonBookingSystemStorage bookingSystemStorage =
                new JsonBookingSystemIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionBookingSystem.json"));
     ...
     */
    private static class JsonBookingSystemIoExceptionThrowingStub extends JsonBookingSystemStorage {
        private JsonBookingSystemIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
