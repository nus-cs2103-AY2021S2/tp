...
import static seedu.smartlib.logic.commands.CommandTestUtil.INVALID_GENRE_DESC;
...
public class AddBookCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_MAZE + AUTHOR_DESC_MAZE
                + PUBLISHER_DESC_MAZE + ISBN_DESC_MAZE + GENRE_DESC_MAZE, new AddBookCommand(expectedBook));
        ...
        assertParseSuccess(parser, NAME_DESC_MAZE + AUTHOR_DESC_MAZE + PUBLISHER_DESC_MAZE
                + ISBN_DESC_HARRY + ISBN_DESC_MAZE + GENRE_DESC_MAZE, new AddBookCommand(expectedBook));

        // multiple genres - last genre accepted
        assertParseSuccess(parser, NAME_DESC_MAZE + AUTHOR_DESC_MAZE + PUBLISHER_DESC_HARRY
                + PUBLISHER_DESC_MAZE + ISBN_DESC_MAZE
                + GENRE_DESC_HARRY + GENRE_DESC_MAZE, new AddBookCommand(expectedBook));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_MAZE + AUTHOR_DESC_MAZE + PUBLISHER_DESC_MAZE + ISBN_DESC_MAZE
                + GENRE_DESC_MAZE, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_MAZE + AUTHOR_DESC_MAZE + VALID_PUBLISHER_MAZE + ISBN_DESC_MAZE
                + VALID_GENRE_MAZE, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_BOOKNAME_DESC + AUTHOR_DESC_MAZE
                + PUBLISHER_DESC_MAZE + ISBN_DESC_MAZE + GENRE_DESC_MAZE, Name.MESSAGE_CONSTRAINTS);

        // invalid author
        assertParseFailure(parser, NAME_DESC_MAZE + INVALID_AUTHOR_DESC
                + PUBLISHER_DESC_MAZE + ISBN_DESC_MAZE + GENRE_DESC_MAZE, Author.MESSAGE_CONSTRAINTS);

        // invalid publisher
        assertParseFailure(parser, NAME_DESC_MAZE + AUTHOR_DESC_MAZE
                + INVALID_PUBLISHER_DESC + ISBN_DESC_MAZE + GENRE_DESC_MAZE, Publisher.MESSAGE_CONSTRAINTS);

        // invalid isbn
        assertParseFailure(parser, NAME_DESC_MAZE + AUTHOR_DESC_MAZE
                + PUBLISHER_DESC_MAZE + INVALID_ISBN_DESC + GENRE_DESC_MAZE, Isbn.MESSAGE_CONSTRAINTS);

        // invalid genre
        assertParseFailure(parser, NAME_DESC_MAZE + AUTHOR_DESC_MAZE
                + PUBLISHER_DESC_MAZE + ISBN_DESC_MAZE + INVALID_GENRE_DESC, Genre.MESSAGE_CONSTRAINTS);
