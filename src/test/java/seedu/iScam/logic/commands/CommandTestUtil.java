...
public class CommandTestUtil {
    ...
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_LOCATION + VALID_LOCATION_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_LOCATION + VALID_LOCATION_BOB;
    ...
    static {
        DESC_AMY = new EditClientDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_LOCATION_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditClientDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_LOCATION_BOB)
