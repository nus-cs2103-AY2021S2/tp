...
import static seedu.address.logic.commands.CommandTestUtil.VALID_DONE;
...
public class TypicalPersons {
    ...
    /**
     * Returns an {@code DeliveryList} with all the typical persons.
     */
    public static DeliveryList getTypicalAddressBook() {
