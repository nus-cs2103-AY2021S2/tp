...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withMatric("A5678901F")
            .withFaculty("USP").withPhone("95352563").withSchoolRes("RVRC").withEmail("heinz@example.com")
            .withVacStatus("vaccinated").withMedDetails("none").withAddress("wall street").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withFaculty("DEN")
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withFaculty("ENG").withPhone("9482224")
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withFaculty("BIZ")
            .withPhone("9482427").withSchoolRes("RVRC").withMatric("A8901234I").withEmail("lydia@example.com")
            .withVacStatus("vaccinated").withMedDetails("none").withAddress("little tokyo").build();
