...
// todo might have messed up layout in this class, move all . to next line
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253")
            .withOrderDescriptions("2 x Strawberry Cakes")
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withOrderDescriptions("1 Vanilla Cake").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street")
            .withOrderDescriptions("1 Chocolate Chip Muffin").withTags("friends").build();
