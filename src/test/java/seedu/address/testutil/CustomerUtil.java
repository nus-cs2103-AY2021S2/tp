...
public class CustomerUtil {
    ...
    public static String getCustomerDetails(Customer customer) {
        ...
        sb.append(PREFIX_DOB + customer.getDateOfBirth().birthDate + " ");
    ...
    public static String getEditCustomerDescriptorDetails(EditCustomerDescriptor descriptor) {
        ...
        descriptor.getDateOfBirth().ifPresent(dateOfBirth -> sb.append(PREFIX_DOB).append(dateOfBirth.birthDate).append(" "));
