...
public class PersonBuilder {
    ...
    public PersonBuilder(Person personToCopy) {
        personName = personToCopy.getName();
     ...
     */
    public PersonBuilder withGroups(String ... tags) {
        this.groups = SampleDataUtil.getGroupSet(tags);
        return this;
    }
    ...
    public Person build() {
        return new Person(personName, phone, email, address, groups);
    }
