...
public class TypicalTasks {
    ...
    public static final Task BENSON = new TaskBuilder().withTitle("Build a gaming PC")
            ...
            .withRecurringSchedule("[08 Mar 2021][Tue][weekly]").withDeadline("12/12/2021").withStartTime("12:30")
    ...
    public static final Task FIONA = new TaskBuilder().withTitle("Final project consult again")
            ...
            .withStartTime("12:30").withRecurringSchedule("[03 Mar 2021][Fri][biweekly]").withDescription("at COM2")
            .withStatus("done").build();
    public static final Task GEORGE = new TaskBuilder().withTitle("Get ready for 2101 presentation")
            .withStartTime("12:30").withDeadline("20/01/2022").withRecurringSchedule("[18 Feb 2021][Sun][weekly]")
    ...
    public static final Task HOON = new TaskBuilder().withTitle("Hoon Meier").withDeadline("04/04/2021")
            .withStartTime("12:30").withRecurringSchedule("[25 Feb 2021][Sat][biweekly]").withDescription("little india")
            .withStatus("done").build();
