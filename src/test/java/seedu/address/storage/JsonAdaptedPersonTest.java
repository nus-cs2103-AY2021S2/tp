...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_MATRICULATION_NUMBER, VALID_PHONE,
    ...
    public void toModelType_invalidMatriculationNumber_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, INVALID_MATRICULATION_NUMBER, VALID_PHONE,
                VALID_EMAIL, VALID_ADDRESS, VALID_VACCINATION_STATUS, VALID_MEDICAL_DETAILS, VALID_SCHOOL_RESIDENCE);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS,
                        VALID_VACCINATION_STATUS, VALID_MEDICAL_DETAILS, VALID_SCHOOL_RESIDENCE);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE,
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS,
                        VALID_VACCINATION_STATUS, VALID_MEDICAL_DETAILS, VALID_SCHOOL_RESIDENCE);
    ...
    public void toModelType_nullVaccinationStatus_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE,
                VALID_EMAIL, VALID_ADDRESS, null, VALID_MEDICAL_DETAILS, VALID_SCHOOL_RESIDENCE);
    ...
    public void toModelType_invalidMedicalDetails_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE,
                VALID_EMAIL, VALID_ADDRESS, VALID_VACCINATION_STATUS, INVALID_MEDICAL_DETAILS, VALID_SCHOOL_RESIDENCE);
    ...
    public void toModelType_nullMedicalDetails_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE,
                VALID_EMAIL, VALID_ADDRESS, VALID_VACCINATION_STATUS, null, VALID_SCHOOL_RESIDENCE);
    ...
    public void toModelType_invalidSchoolResidence_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_MATRICULATION_NUMBER, VALID_PHONE,
                VALID_EMAIL, VALID_ADDRESS, VALID_VACCINATION_STATUS, VALID_MEDICAL_DETAILS, INVALID_SCHOOL_RESIDENCE);
