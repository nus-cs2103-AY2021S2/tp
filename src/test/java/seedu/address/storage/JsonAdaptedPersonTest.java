...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL, VALID_ADDRESS,
                        VALID_GUARDIAN_NAME, VALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL,
                VALID_ADDRESS, VALID_GUARDIAN_NAME, VALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL,
                null, VALID_GUARDIAN_NAME, VALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
    ...
    public void toModelType_invalidGuardianName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_GUARDIAN_NAME, VALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
        String expectedMessage = Name.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullGuardianName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL,
                VALID_ADDRESS, null, VALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, Name.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidGuardianPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL, VALID_ADDRESS,
                        VALID_GUARDIAN_NAME, INVALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
        String expectedMessage = Phone.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullGuardianPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL,
                VALID_ADDRESS, VALID_GUARDIAN_NAME, null, VALID_LEVEL, VALID_TAGS, VALID_LESSON);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, Phone.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL, VALID_ADDRESS,
                        VALID_GUARDIAN_NAME, VALID_GUARDIAN_PHONE, VALID_LEVEL, invalidTags, VALID_LESSON);
    ...
    public void toModelType_invalidLesson_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_SCHOOL, VALID_EMAIL, VALID_ADDRESS,
                        VALID_GUARDIAN_NAME, VALID_GUARDIAN_PHONE, VALID_LEVEL, VALID_TAGS, invalidLesson);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
