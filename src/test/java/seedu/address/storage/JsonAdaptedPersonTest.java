...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_PHONE, VALID_QUESTION, VALID_ANSWER, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_QUESTION, VALID_ANSWER, VALID_TAGS);
    ...
    public void toModelType_invalidquestion_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_PHONE, INVALID_QUESTION, VALID_ANSWER, VALID_TAGS);
    ...
    public void toModelType_nullquestion_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_PHONE, null, VALID_ANSWER, VALID_TAGS);
    ...
    public void toModelType_invalidANSWER_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_PHONE, VALID_QUESTION, INVALID_ANSWER, VALID_TAGS);
    ...
    public void toModelType_nullAnswer_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_PHONE, VALID_QUESTION, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_PHONE, VALID_QUESTION, VALID_ANSWER, invalidTags);
