...
public class StorageManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTaskTrackerStorage taskTrackerStorage = new JsonTaskTrackerStorage(getTempFilePath("ab"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(getTempFilePath("prefs"));
        storageManager = new StorageManager(taskTrackerStorage, userPrefsStorage);
    }
    ...
    public void taskTrackerReadSave() throws Exception {
        /*
         * Note: This is an integration test that verifies the StorageManager is properly wired to the
         * {@link JsonTaskTrackerStorage} class.
         * More extensive testing of UserPref saving/reading is done in {@link JsonTaskTrackerStorageTest} class.
         */
