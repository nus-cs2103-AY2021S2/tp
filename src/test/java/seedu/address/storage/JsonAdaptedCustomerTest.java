...
public class JsonAdaptedCustomerTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedCustomer customer = new JsonAdaptedCustomer(null, VALID_PHONE, VALID_EMAIL,
            VALID_ADDRESS, VALID_DATE_OF_BIRTH, VALID_TAGS, null, null, null);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedCustomer customer = new JsonAdaptedCustomer(VALID_NAME, VALID_PHONE,
            null, VALID_ADDRESS, VALID_DATE_OF_BIRTH, VALID_TAGS, null, null, null);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedCustomer customer =
            new JsonAdaptedCustomer(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_DATE_OF_BIRTH,
                    VALID_TAGS, null, null, null);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedCustomer customer =
            new JsonAdaptedCustomer(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                    invalidTags, null, null, null);
