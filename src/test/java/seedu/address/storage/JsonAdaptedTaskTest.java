...
public class JsonAdaptedTaskTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTask person = new JsonAdaptedTask(null, VALID_PHONE, VALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedTask person = new JsonAdaptedTask(VALID_NAME, null, VALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedTask person = new JsonAdaptedTask(VALID_NAME, VALID_PHONE, null, VALID_TAGS);
