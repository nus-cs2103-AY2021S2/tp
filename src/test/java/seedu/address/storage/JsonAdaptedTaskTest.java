...
public class JsonAdaptedTaskTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(INVALID_NAME, VALID_CODE, VALID_PHONE, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(null, VALID_CODE, VALID_PHONE,
    ...
    public void toModelType_invalidCode_throwsIllegalValueException() {
        JsonAdaptedTask task =
            new JsonAdaptedTask(VALID_NAME, INVALID_CODE, VALID_PHONE, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullCode_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, null, VALID_PHONE, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_CODE, INVALID_PHONE, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_CODE, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_CODE, VALID_PHONE, VALID_REMARK, invalidTags);
