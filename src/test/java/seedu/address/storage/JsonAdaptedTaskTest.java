...
public class JsonAdaptedTaskTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(INVALID_NAME, VALID_CODE, VALID_WEIGHTAGE, VALID_PHONE, VALID_EMAIL, VALID_REMARK,
                        VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(null, VALID_CODE, VALID_WEIGHTAGE, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_invalidCode_throwsIllegalValueException() {
        JsonAdaptedTask task =
            new JsonAdaptedTask(VALID_NAME, INVALID_CODE, VALID_WEIGHTAGE, VALID_PHONE, VALID_EMAIL, VALID_REMARK,
                    VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_CODE, VALID_WEIGHTAGE,
                        INVALID_PHONE, VALID_EMAIL, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_CODE, VALID_WEIGHTAGE, null, VALID_EMAIL,
                VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_CODE, VALID_WEIGHTAGE,
                        VALID_PHONE, INVALID_EMAIL, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_CODE, VALID_WEIGHTAGE, VALID_PHONE, null,
                VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_CODE, VALID_WEIGHTAGE, VALID_PHONE, VALID_EMAIL, VALID_REMARK,
                        invalidTags);
