...
public class JsonSerializableRemindMeTest {
    ...
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        JsonSerializableRemindMe dataFromFile = JsonUtil.readJsonFile(INVALID_PERSON_FILE,
                JsonSerializableRemindMe.class).get();
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        JsonSerializableRemindMe dataFromFile = JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE,
                JsonSerializableRemindMe.class).get();
