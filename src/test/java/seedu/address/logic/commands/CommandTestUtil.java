...
public class CommandTestUtil {
    ...
    public static final String TAG_DESC_CLEAN = " " + PREFIX_CLEAN_STATUS_TAG + VALID_TAG_CLEAN;
    public static final String TAG_DESC_FRIEND = " " + PREFIX_TAG + VALID_TAG_FRIEND;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_TAG + VALID_TAG_HUSBAND;
    public static final String TAG_DESC_RESERVED = " " + PREFIX_TAG + VALID_TAG_RESERVED;
    public static final String TAG_DESC_BOOKED = " " + PREFIX_TAG + VALID_TAG_BOOKED;
    ...
    static {
        ...
        DESC_RESIDENCE1 = new EditResidenceDescriptorBuilder().build();
    }
     ...
     * - the address book, filtered residence list and selected residence in {@code actualModel} remain unchanged
     */
