...
public class CommandTestUtil {
    ...
    public static final String VALID_ROOM_AMY = "#09-23";
    public static final String VALID_ROOM_BOB = "#10-23";
    ...
    public static final EditResidentCommand.EditPersonDescriptor DESC_AMY;
    public static final EditResidentCommand.EditPersonDescriptor DESC_BOB;
