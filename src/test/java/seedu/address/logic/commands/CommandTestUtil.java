...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_JANE = "Jane Vermilion";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_PHONE_JANE = "87514098";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMAIL_JANE = "jane@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_ADDRESS_JANE = "7th street";
    public static final String VALID_REMARK_AMY = "No remark";
    public static final String VALID_REMARK_BOB = "";
    public static final String VALID_REMARK_JANE = "On leave of absence";
    public static final String VALID_MODE_OF_CONTACT_AMY = "email";
    public static final String VALID_MODE_OF_CONTACT_BOB = "phone";
    public static final String VALID_MODE_OF_CONTACT_JANE = "phone";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final Boolean VALID_BLACKLIST_AMY = false;
    public static final Boolean VALID_BLACKLIST_BOB = false;
    public static final Boolean VALID_BLACKLIST_JANE = true;
    ...
    public static final String INVALID_MODE_OF_CONTACT_DESC = " " + PREFIX_MODE_OF_CONTACT + "no";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                ...
                .withModeOfContact(VALID_MODE_OF_CONTACT_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                ...
                .withModeOfContact(VALID_MODE_OF_CONTACT_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
        DESC_JANE = new EditPersonDescriptorBuilder().withName(VALID_NAME_JANE).withPhone(VALID_PHONE_JANE)
                .withEmail(VALID_EMAIL_JANE).withAddress(VALID_ADDRESS_JANE).withRemark(VALID_REMARK_JANE)
                .withModeOfContact(VALID_MODE_OF_CONTACT_JANE).build();
    }
