...
import seedu.address.logic.ExactMatchPredicate;
...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_OF_BIRTH_AMY = "2000 01 31";
    public static final String VALID_DATE_OF_BIRTH_BOB = "1999 12 13";
    ...
    public static final String DATE_OF_BIRTH_DESC_AMY = " " + PREFIX_DOB + VALID_DATE_OF_BIRTH_AMY;
    public static final String DATE_OF_BIRTH_DESC_BOB = " " + PREFIX_DOB + VALID_DATE_OF_BIRTH_BOB;
    ...
    public static final String INVALID_DATE_OF_BIRTH_DESC = " " + PREFIX_DOB + "2000 14 03"; // 14th month is invalid
    ...
    public static void showCustomerAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredCustomerList(new ExactMatchPredicate(customer));
