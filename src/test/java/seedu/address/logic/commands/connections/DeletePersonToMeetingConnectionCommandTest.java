...
class DeletePersonToMeetingConnectionCommandTest {
    ...
    public DeletePersonToMeetingConnectionCommandTest() {
        ...
        MEETING1.setPersonMeetingConnection(connection);
        MEETING2.setPersonMeetingConnection(connection);
        MEETING3.setPersonMeetingConnection(connection);
    }
    ...
    public void execute_connectionAcceptedByModel_addFail() throws Exception {
        ...
        // The meeting index is out of bounds.
