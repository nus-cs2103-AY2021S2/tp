...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        EditCommand editCommand = new EditCommand(Collections.singletonList(INDEX_FIRST_PERSON),
                descriptor);
    ...
    public void execute_bulkEditPhoneSpecifiedIndexes_success() {
        ...
        EditCommand editCommand = new EditCommand(List.of(INDEX_FIRST_PERSON, INDEX_THIRD_PERSON),
                descriptor);
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        EditCommand editCommand = new EditCommand(Collections.singletonList(indexLastPerson),
                descriptor);
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        ...
        EditCommand editCommand = new EditCommand(Collections.singletonList(INDEX_SECOND_PERSON), descriptor);
    ...
    public void execute_invalidPersonIndexUnfilteredList_failure() {
        ...
        EditCommand editCommand = new EditCommand(Collections.singletonList(outOfBoundIndex),
                descriptor);
    ...
    public void equals() {
        ...
        final EditCommand commandWithIndexes = new EditCommand(VALID_INDEXES, DESC_AMY);
        ...
        assertEquals(new EditCommand(VALID_INDEXES, DESC_AMY),
                new EditCommand(VALID_INDEXES, DESC_AMY));
        assertEquals(new EditCommand(DESC_AMY), new EditCommand(DESC_AMY));
        ...
        assertNotEquals(new EditCommand(Collections.singletonList(INDEX_SECOND_PERSON), DESC_AMY),
                standardCommand);
        assertEquals(commandWithIndexes, standardCommand);

        // different descriptor -> returns false
        assertNotEquals(new EditCommand(Collections.singletonList(INDEX_FIRST_PERSON), DESC_BOB),
                standardCommand);
        assertNotEquals(new EditCommand(VALID_INDEXES, DESC_BOB),
                standardCommand);
    }
