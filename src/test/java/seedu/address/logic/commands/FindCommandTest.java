...
public class FindCommandTest {
    ...
    private Model expectedModel = new ModelManager(getTypicalAddressBook(), new UserPrefs(), getTypicalAliasMap());
    ...
    public void equals() {
        ...
        FindCommand findFirstCommand = new FindCommand(firstPredicate, firstPredicate);
        FindCommand findSecondCommand = new FindCommand(secondPredicate, secondPredicate);

        // same object -> returns true
        assertEquals(findFirstCommand, findFirstCommand);

        // same values -> returns true
        FindCommand findFirstCommandCopy = new FindCommand(firstPredicate, firstPredicate);
    ...
    public void execute_zeroKeywords_noPersonFound() {
        ...
        FindCommand command = new FindCommand(predicate, predicate);
