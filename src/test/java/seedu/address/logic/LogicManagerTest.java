...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonAddressBookStorage addressBookStorage =
                new JsonAddressBookStorage(temporaryFolder.resolve("docBob.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute add command
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + DOB_DESC_AMY + GENDER_DESC_AMY + PHONE_DESC_AMY
