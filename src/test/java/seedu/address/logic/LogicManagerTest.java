...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTutorBookStorage addressBookStorage =
                new JsonTutorBookStorage(temporaryFolder.resolve("addressBook.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        JsonAppointmentBookStorage appointmentBookStorage =
                new JsonAppointmentBookStorage(temporaryFolder.resolve(
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = "delete_tutor 9";
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonTutorBookStorage addressBookStorage =
                new JsonTutorBookIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
        JsonUserPrefsStorage userPrefsStorage =
                new JsonUserPrefsStorage(temporaryFolder.resolve("ioExceptionUserPrefs.json"));
        JsonAppointmentBookStorage appointmentBookStorage =
                new JsonAppointmentBookStorage(temporaryFolder.resolve(
                        "ioExceptionAppointmentBook.json"));
        JsonGradeBookStorage gradeBookStorage =
                new JsonGradeBookStorage(temporaryFolder.resolve(
     ...
     */
    private static class JsonTutorBookIoExceptionThrowingStub extends JsonTutorBookStorage {
        private JsonTutorBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
