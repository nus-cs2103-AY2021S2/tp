...
public class ParentPalParserTest {
    ...
    public void parseCommand_delete() throws Exception {
        ...
        assertEquals(new DeleteCommand(new ArrayList<Index>(List.of(INDEX_FIRST_CONTACT))), command);
    }
    ...
    public void parseCommand_help() throws Exception {
        ...
        assertTrue(parser.parseCommand(HelpCommand.COMMAND_WORD + " find") instanceof HelpCommand);
    }
