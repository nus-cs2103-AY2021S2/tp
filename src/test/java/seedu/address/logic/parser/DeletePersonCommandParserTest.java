 ...
 * outside of the DeletePersonCommand code. For example, inputs "s/1" and "s/1 abc" take the
...
public class DeletePersonCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "s/1", new DeletePersonCommand(FIRST_PERSON_ID));
    }
