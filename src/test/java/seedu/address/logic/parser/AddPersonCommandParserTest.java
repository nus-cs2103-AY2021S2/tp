...
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_AMY_NEW;
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_BOB_NEW;
...
public class AddPersonCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB_NEW + PHONE_DESC_BOB + VALID_EMAIL_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB_NEW + INVALID_PHONE_DESC + EMAIL_DESC_BOB , Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB_NEW + PHONE_DESC_BOB + INVALID_EMAIL_DESC , Email.MESSAGE_CONSTRAINTS);
