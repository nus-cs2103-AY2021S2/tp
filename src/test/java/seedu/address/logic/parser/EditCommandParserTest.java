...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5 " + PREFIX_NAME + NAME_DESC_AMY, ParserUtil.MESSAGE_INVALID_INDEX + "\n"
                + EditCommand.MESSAGE_USAGE);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor, EditCommand.EditPolicyMode.REPLACE);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditCommand(targetIndex, descriptor, EditCommand.EditPolicyMode.REPLACE);
        assertParseSuccess(parser, userInput, expectedCommand);
