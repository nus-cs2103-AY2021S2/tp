...
public class EditCommandParserTest {
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditItemDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + LOCATION_DESC_BOB
            + PHONE_DESC_BOB;
        descriptor = new EditItemDescriptorBuilder().withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
