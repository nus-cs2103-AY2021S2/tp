...
public class EditCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        assertParseFailure(parser, "", MESSAGE_INVALID_CONTACT_DISPLAYED_INDEX);
    }
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditCommand.EditContactDescriptor descriptor = new EditContactDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_resetTags_success() {
        ...
        EditCommand.EditContactDescriptor descriptor = new EditContactDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
