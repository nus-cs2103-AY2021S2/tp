...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DEADLINE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + DESCRIPTION_DESC_AMY + TITLE_DESC_AMY + TAG_DESC_FRIEND;

        EditTaskDescriptor descriptor = new EditTaskDescriptorBuilder().withTitle(VALID_TITLE_AMY)
                .withDeadline(VALID_DEADLINE_BOB).withEmail(VALID_EMAIL_AMY).withDescription(VALID_DESCRIPTION_AMY)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_TASK;
        String userInput = targetIndex.getOneBased() + DEADLINE_DESC_AMY + DESCRIPTION_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + DEADLINE_DESC_AMY + DESCRIPTION_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + DEADLINE_DESC_BOB + DESCRIPTION_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_DEADLINE_DESC + DESCRIPTION_DESC_BOB
                + DEADLINE_DESC_BOB;
        descriptor = new EditTaskDescriptorBuilder().withDeadline(VALID_DEADLINE_BOB).withEmail(VALID_EMAIL_BOB)
