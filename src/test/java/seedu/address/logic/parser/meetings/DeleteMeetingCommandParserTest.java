...
/**
 * As we are only doing white-box testing, our isWithinRange cases do not cover path variations
 * outside of the DeletePersonCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the DeletePersonCommand, and therefore we isWithinRange only one of them.
