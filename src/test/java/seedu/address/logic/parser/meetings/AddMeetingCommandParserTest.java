...
import static seedu.address.logic.commands.meetings.MeetingCommandTestUtil.*;
...
class AddMeetingCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero group
        Meeting expectedMeeting = new MeetingBuilder(MEETING1).withPriority("1").withDescription("").withGroups().build();
        assertParseSuccess(parser, NAME_DESC_MEETING1 + START_DESC_MEETING1 + END_DESC_MEETING1,
