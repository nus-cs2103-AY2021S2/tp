...
public class AddContactCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Contact expectedcontact = new ContactBuilder(BENSON).withTags(VALID_TAG_FRIEND).build();
        ...
        Contact expectedcontactMultipleTags = new ContactBuilder(BENSON).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Contact expectedcontact = new ContactBuilder(ALICE).withTags().build();
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, ContactPhone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, ContactEmail.MESSAGE_CONSTRAINTS);
