...
class DriveCommandParserTest {
    private DriveCommandParser parser = new DriveCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB
                ...
                new DriveCommand(expectedDriver, expectedCommuters));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, DriveCommand.MESSAGE_USAGE);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB
                ...
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, DriveCommand.MESSAGE_USAGE));
    }
