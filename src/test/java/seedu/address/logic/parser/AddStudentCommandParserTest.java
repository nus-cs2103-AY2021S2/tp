...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_STUDY_LEVEL_DESC;
...
import static seedu.address.logic.commands.CommandTestUtil.STUDY_LEVEL_DESC_BOB;
...
public class AddStudentCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing guardian level prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + GUARDIAN_PHONE_DESC_BOB + STUDY_LEVEL_DESC_BOB + VALID_STUDY_LEVEL_BOB, expectedMessage);

        // missing study level prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + GUARDIAN_PHONE_DESC_BOB + VALID_STUDY_LEVEL_BOB + RELATIONSHIP_DESC_BOB, expectedMessage);

        // missing relationship prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + GUARDIAN_PHONE_DESC_BOB + STUDY_LEVEL_DESC_BOB + VALID_RELATIONSHIP_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + INVALID_GUARDIAN_PHONE_DESC + STUDY_LEVEL_DESC_BOB + RELATIONSHIP_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid study level
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + GUARDIAN_PHONE_DESC_BOB + INVALID_STUDY_LEVEL_DESC + RELATIONSHIP_DESC_BOB,
            "Study level can be anything but should not be empty.");

        // invalid relationship
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + GUARDIAN_PHONE_DESC_BOB + STUDY_LEVEL_DESC_BOB + INVALID_RELATIONSHIP_DESC,
            "Relationship can be anything but should not be empty.");
