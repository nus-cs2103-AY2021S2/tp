...
public class CustomerEditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        assertParseFailure(parser, "1" + INVALID_NAME_DESC, ParserUtil.MESSAGE_INVALID_NAME); // invalid name
        assertParseFailure(parser, "1" + INVALID_PHONE_DESC, ParserUtil.MESSAGE_INVALID_PHONE); // invalid phone
        assertParseFailure(parser, "1" + INVALID_EMAIL_DESC, ParserUtil.MESSAGE_INVALID_EMAIL); // invalid email
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, ParserUtil.MESSAGE_INVALID_ADDRESS); // invalid address
        // assertParseFailure(parser, "1" + INVALID_TAG_DESC, ParserUtil); // invalid tag

        // invalid phone followed by valid email
        assertParseFailure(parser, "1" + INVALID_PHONE_DESC + EMAIL_DESC_AMY, ParserUtil.MESSAGE_INVALID_PHONE);

        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        assertParseFailure(parser, "1" + PHONE_DESC_BOB + INVALID_PHONE_DESC, ParserUtil.MESSAGE_INVALID_PHONE);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY
                + VALID_PHONE_AMY, ParserUtil.MESSAGE_INVALID_NAME);
    }
