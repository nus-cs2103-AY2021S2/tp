...
public class ParserUtilTest {
    ...
    @Test
    public void parseIndex_invalidInput_throwsInvalidArgumeentException() {
        assertThrows(IllegalArgumentException.class, MESSAGE_INVALID_INDEX_TYPE, () -> ParserUtil.parseIndex("10 a"));
    }
