...
public class AddressBookParserTest {
    ...
    public void parseCommand_find() throws Exception {
        ...
        FindCommand command = (FindCommand) parser.parseCommand(
                MessageFormat.format("{0} {1}", FindCommand.COMMAND_WORD, keywords.stream().collect(Collectors.joining(" "))), emptyAliases);
        String s = MessageFormat.format("{0} {1}", FindCommand.COMMAND_WORD, keywords.stream().collect(Collectors.joining(" ")));
    ...
    public void parseCommand_findName() throws Exception {
        List<String> keywords = Arrays.asList("foo", "bar", "baz");
        FindCommand command = (FindCommand) parser.parseCommand(
                MessageFormat.format("{0} {1} {2}", FindCommand.COMMAND_WORD, PREFIX_NAME, keywords.stream().collect(Collectors.joining(" "))), emptyAliases);
    ...
    public void parseCommand_findTag() throws Exception {
        List<String> keywords = Arrays.asList("foo", "bar", "baz");
        FindCommand command = (FindCommand) parser.parseCommand(
                MessageFormat.format("{0} {1} {2}", FindCommand.COMMAND_WORD, PREFIX_TAG, keywords.stream().collect(Collectors.joining(" "))), emptyAliases);
    ...
    public void parseCommand_findRemark() throws Exception {
        List<String> keywords = Arrays.asList("foo", "bar", "baz");
        FindCommand command = (FindCommand) parser.parseCommand(
                MessageFormat.format("{0} {1} {2}", FindCommand.COMMAND_WORD, PREFIX_REMARK, keywords.stream().collect(Collectors.joining(" "))), emptyAliases);
    ...
    public void parseCommand_findEmail() throws Exception {
        List<String> keywords = Arrays.asList("foo", "bar", "baz");
        FindCommand command = (FindCommand) parser.parseCommand(
                MessageFormat.format("{0} {1} {2}", FindCommand.COMMAND_WORD, PREFIX_EMAIL, keywords.stream().collect(Collectors.joining(" "))), emptyAliases);
