...
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_PLAY_DATE;
...
public class AddAppointmentCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_PTM + ADDRESS_DESC_PTM
                + DATE_DESC_PTM, new AddAppointmentCommand(expectedAppointment));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_PTM + ADDRESS_DESC_PTM + DATE_DESC_PTM,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_PTM + VALID_ADDRESS_PTM + VALID_DATE_PTM,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + ADDRESS_DESC_PTM + DATE_DESC_PTM,
                Name.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_PTM + INVALID_ADDRESS_DESC + DATE_DESC_PTM,
                Address.MESSAGE_CONSTRAINTS);

        // invalid date
        assertParseFailure(parser, NAME_DESC_PTM + ADDRESS_DESC_PTM + INVALID_DATE_DESC ,
