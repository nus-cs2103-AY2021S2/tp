...
public class DeletePropertyCommandParserTest {
    ...
    @Test
    public void parse_validArgs_returnsDeletePropertyCommand() {
        assertParseSuccess(parser, "1", new DeletePropertyCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeletePropertyCommand.MESSAGE_USAGE));
    }
}
