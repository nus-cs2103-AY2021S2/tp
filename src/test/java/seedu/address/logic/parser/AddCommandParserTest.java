...
import static seedu.address.logic.commands.CommandTestUtil.SUBJECT_NAME_DESC;
import static seedu.address.logic.commands.CommandTestUtil.SUBJECT_LEVEL_DESC;
import static seedu.address.logic.commands.CommandTestUtil.SUBJECT_RATE_DESC;
import static seedu.address.logic.commands.CommandTestUtil.SUBJECT_EXPERIENCE_DESC;
import static seedu.address.logic.commands.CommandTestUtil.SUBJECT_QUALIFICATION_DESC;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                ...
                + SUBJECT_RATE_DESC + SUBJECT_EXPERIENCE_DESC + SUBJECT_QUALIFICATION_DESC, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                ...
                + SUBJECT_RATE_DESC + SUBJECT_EXPERIENCE_DESC + SUBJECT_QUALIFICATION_DESC, new AddCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB, expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_GENDER_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB, expectedMessage);
