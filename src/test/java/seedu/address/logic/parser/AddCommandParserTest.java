...
import static seedu.address.logic.commands.CommandTestUtil.SUBJECT_DESC_CHEM;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withSubjects(VALID_SUBJECT_MATH)
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB
                ...
                + SUBJECT_DESC_MATH + LESSON_DESC_BOB, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB
                ...
                + GUARDIAN_PHONE_DESC_BOB + SUBJECT_DESC_MATH + LESSON_DESC_BOB, new AddCommand(expectedPerson));
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withSubjects(VALID_SUBJECT_MATH, VALID_SUBJECT_CHEM)
                .withLessons(VALID_LESSON_BOB).build();
        assertParseSuccess(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + LESSON_DESC_BOB, new AddCommand(expectedPersonMultipleTags));

        // multiple lessons - all accepted
        Person expectedPersonMultipleLessons = new PersonBuilder(BOB).withSubjects(VALID_SUBJECT_MATH)
                .withLessons(VALID_LESSON_BOB, VALID_LESSON_AMY).build();
        assertParseSuccess(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_MATH + LESSON_DESC_BOB + LESSON_DESC_AMY, new AddCommand(expectedPersonMultipleLessons));
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPersonWithoutTags = new PersonBuilder(AMY).withSubjects().withLessons(VALID_LESSON_AMY).build();
        ...
        // zero lessons
        Person expectedPersonWithoutLessons = new PersonBuilder(AMY).withSubjects(VALID_SUBJECT_MATH)
                .withLessons().build();
        assertParseSuccess(parser, NAME_DESC_AMY + SCHOOL_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                        + ADDRESS_DESC_AMY + GUARDIAN_NAME_DESC_AMY + GUARDIAN_PHONE_DESC_AMY + SUBJECT_DESC_MATH,
                new AddCommand(expectedPersonWithoutLessons));

        // zero tags and lessons
        Person expectedPersonWithoutOptionalFields =
                new PersonBuilder(AMY).withSubjects().withLessons().build();
        assertParseSuccess(parser, NAME_DESC_AMY + SCHOOL_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_PHONE_BOB + SCHOOL_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_SCHOOL_BOB + VALID_EMAIL_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + SCHOOL_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + LESSON_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + LESSON_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC
                + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + LESSON_DESC_BOB, Email.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + LESSON_DESC_BOB, Address.MESSAGE_CONSTRAINTS);

        // invalid subject
        assertParseFailure(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + INVALID_SUBJECT_DESC + VALID_SUBJECT_MATH + LESSON_DESC_BOB, Subject.MESSAGE_CONSTRAINTS);

        // invalid lesson
        assertParseFailure(parser, NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + INVALID_LESSON_DESC, Lesson.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + SCHOOL_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GUARDIAN_NAME_DESC_BOB + GUARDIAN_PHONE_DESC_BOB
                + SUBJECT_DESC_CHEM + SUBJECT_DESC_MATH + LESSON_DESC_BOB,
