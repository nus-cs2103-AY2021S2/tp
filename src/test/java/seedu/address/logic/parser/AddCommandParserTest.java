...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, TITLE_DESC_AMY + TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB
                + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple deadlines - last deadline accepted
        assertParseSuccess(parser, TITLE_DESC_BOB + DEADLINE_DESC_AMY + DEADLINE_DESC_BOB + DURATION_DESC_BOB
                + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple durations - last duration accepted
        assertParseSuccess(parser, TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_AMY + DURATION_DESC_BOB
                + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple recurringTasks - last recurringTasks accepted
        assertParseSuccess(parser, TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB
        ...
        assertParseSuccess(parser, TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB + RECURRINGSCHEDULE_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, TITLE_DESC_AMY + DEADLINE_DESC_AMY + DURATION_DESC_AMY + RECURRINGSCHEDULE_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_TITLE_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid title
        assertParseFailure(parser, INVALID_TITLE_DESC + DEADLINE_DESC_BOB + DURATION_DESC_BOB
                + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Title.MESSAGE_CONSTRAINTS);

        // invalid deadline
        assertParseFailure(parser, TITLE_DESC_BOB + INVALID_DEADLINE_DESC + DURATION_DESC_BOB
                + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Deadline.MESSAGE_CONSTRAINTS);

        // invalid duration
        assertParseFailure(parser, TITLE_DESC_BOB + DEADLINE_DESC_BOB + INVALID_DURATION_DESC
                + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Duration.MESSAGE_CONSTRAINTS);

        // invalid recurringSchedule
        assertParseFailure(parser, TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB
        ...
        // invalid tag
        assertParseFailure(parser, TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB + RECURRINGSCHEDULE_DESC_BOB
        ...
        assertParseFailure(parser, INVALID_TITLE_DESC + DEADLINE_DESC_BOB + DURATION_DESC_BOB + EMAIL_DESC_BOB
                        + INVALID_DESCRIPTION_DESC, Title.MESSAGE_CONSTRAINTS);
         */

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + TITLE_DESC_BOB + DEADLINE_DESC_BOB + DURATION_DESC_BOB
                        + RECURRINGSCHEDULE_DESC_BOB + DESCRIPTION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
