...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + SIZE_DESC_BOB + EMAIL_DESC_BOB + DRESSCODE_DESC_AMY
                + DRESSCODE_DESC_BOB + DESCRIPTION_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB)
                ...
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + SIZE_DESC_BOB + EMAIL_DESC_BOB + DRESSCODE_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + SIZE_DESC_AMY + EMAIL_DESC_AMY + DRESSCODE_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + SIZE_DESC_BOB + EMAIL_DESC_BOB + DRESSCODE_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_SIZE_BOB + EMAIL_DESC_BOB + DRESSCODE_DESC_BOB,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_BOB + SIZE_DESC_BOB + VALID_EMAIL_BOB + DRESSCODE_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + SIZE_DESC_BOB + EMAIL_DESC_BOB + VALID_DRESSCODE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_SIZE_BOB + VALID_EMAIL_BOB + VALID_DRESSCODE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + SIZE_DESC_BOB + EMAIL_DESC_BOB + INVALID_DRESSCODE_DESC
                + DESCRIPTION_DESC_HUSBAND + DESCRIPTION_DESC_FRIEND, DressCode.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + SIZE_DESC_BOB + EMAIL_DESC_BOB + DRESSCODE_DESC_BOB
                + INVALID_DESCRIPTION_DESC + VALID_DESCRIPTION_FRIEND, Description.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + SIZE_DESC_BOB + EMAIL_DESC_BOB + INVALID_DRESSCODE_DESC,
