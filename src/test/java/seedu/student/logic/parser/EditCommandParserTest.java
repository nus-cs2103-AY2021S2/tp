...
import static seedu.student.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
...
import static seedu.student.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static seedu.student.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.student.logic.commands.CommandTestUtil.VALID_FACULTY_AMY;
import static seedu.student.logic.commands.CommandTestUtil.VALID_MATRIC_AMY;
import static seedu.student.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static seedu.student.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
import static seedu.student.logic.commands.CommandTestUtil.VALID_PHONE_BOB;
import static seedu.student.logic.commands.CommandTestUtil.VALID_RESIDENCE_AMY;
import static seedu.student.logic.commands.CommandTestUtil.VALID_STATUS_AMY;
...
import static seedu.student.testutil.TypicalIndexes.INDEX_SECOND_STUDENT;
import static seedu.student.testutil.TypicalIndexes.INDEX_THIRD_STUDENT;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_STATUS_DESC, VaccinationStatus.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, " 1" + INVALID_DETAILS_DESC, MedicalDetails.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + INVALID_RESIDENCE_DESC, SchoolResidence.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder().withName(VALID_NAME_AMY)
                .withMatric(VALID_MATRIC_AMY).withFaculty(VALID_FACULTY_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withVacStatus(VALID_STATUS_AMY).withSchoolRes(VALID_RESIDENCE_AMY)
                .withMedDetails(VALID_DETAILS_BOB).build();
