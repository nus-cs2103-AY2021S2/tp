...
public class FindStudentCommandParserTest {
    ...
    public void parse_emptyArg_throwsParseException() {
        assertParseFailure(parser, "     ", String.format(MatriculationNumber.MESSAGE_CONSTRAINTS,
                FindStudentAndAppointmentCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_validArgs_returnsFindCommand() {
        ...
        FindStudentAndAppointmentCommand expectedFindCommand =
                new FindStudentAndAppointmentCommand(new StudentContainsMatriculationNumberPredicate(matriculationNumber),
