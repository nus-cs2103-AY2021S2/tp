...
import seedu.plan.model.plan.DescriptionContainsKeywordsPredicate;
...
public class CommandTestUtil {
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        ModulePlanner expectedModulePlanner = new ModulePlanner(actualModel.getPlans());
        List<Plan> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPlanList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedModulePlanner, actualModel.getPlans());
