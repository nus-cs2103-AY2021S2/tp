...
public class JsonAdaptedTaskTest {
    ...
    private static final String VALID_ADDRESS = MIDTERM.getDescription().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(INVALID_NAME, VALID_DEADLINE, VALID_MODULE,
                        VALID_ADDRESS, VALID_DONE_STATUS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_DEADLINE, VALID_MODULE,
                        INVALID_ADDRESS, VALID_DONE_STATUS, VALID_TAGS);;
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_DEADLINE, VALID_MODULE,
                        VALID_ADDRESS, VALID_DONE_STATUS, invalidTags);
