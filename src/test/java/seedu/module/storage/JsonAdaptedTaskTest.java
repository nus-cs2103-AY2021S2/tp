...
public class JsonAdaptedTaskTest {
    ...
    private static final String INVALID_RECURRENCE = "invalid recurrence";
    ...
    private static final String VALID_RECURRENCE = MIDTERM.getRecurrence().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(INVALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                        VALID_DESCRIPTION, VALID_WORKLOAD, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(null, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                VALID_DESCRIPTION, VALID_WORKLOAD, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_nullModule_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, null,
                VALID_DESCRIPTION, VALID_WORKLOAD, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedTask task =
                new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                        INVALID_DESCRIPTION, VALID_WORKLOAD, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                null, VALID_WORKLOAD, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_invalidDoneStatus_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                VALID_DESCRIPTION, VALID_WORKLOAD, INVALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_nullDoneStatus_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                VALID_DESCRIPTION, VALID_WORKLOAD, null, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_invalidWorkload_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                VALID_DESCRIPTION, INVALID_WORKLOAD, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
    ...
    public void toModelType_nullWorkload_throwsIllegalValueException() {
        JsonAdaptedTask task = new JsonAdaptedTask(VALID_NAME, VALID_START_TIME, VALID_DEADLINE, VALID_MODULE,
                VALID_DESCRIPTION, null, VALID_DONE_STATUS, VALID_RECURRENCE, VALID_TAGS);
