...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + QUANTITY_DESC_BANANA + EXPIRYDATE_DESC_BANANA
            + LOCATION_DESC_BANANA + TAG_DESC_FAVOURITE + TAG_DESC_ESSENTIAL, ItemName.MESSAGE_CONSTRAINTS);

        // invalid quantity
        assertParseFailure(parser, NAME_DESC_BANANA + INVALID_QUANTITY_DESC + EXPIRYDATE_DESC_BANANA
            + LOCATION_DESC_BANANA + TAG_DESC_FAVOURITE + TAG_DESC_ESSENTIAL, Quantity.MESSAGE_CONSTRAINTS);

        // invalid expirydate
        assertParseFailure(parser, NAME_DESC_BANANA + QUANTITY_DESC_BANANA + INVALID_EXPIRYDATE_DESC
            + LOCATION_DESC_BANANA + TAG_DESC_FAVOURITE + TAG_DESC_ESSENTIAL, ExpiryDate.MESSAGE_CONSTRAINTS);
