 ...
 * outside of the DeleteNote code. For example, inputs "1" and "1 abc" take the
 * same path through the DeleteNote, and therefore we test only one of them.
...
public class DeleteNoteCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new DeleteNoteCommand(INDEX_FIRST_NOTE));
    }
