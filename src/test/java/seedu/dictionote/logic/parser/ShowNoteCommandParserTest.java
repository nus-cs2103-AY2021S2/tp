 ...
 */
public class ShowNoteCommandParserTest {
    private ShowNoteCommandParser parser = new ShowNoteCommandParser();

    @Test
    public void parse_validArgs_returnsShowCommand() {
        assertParseSuccess(parser, "1", new ShowNoteCommand(INDEX_FIRST_NOTE));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                ShowNoteCommand.MESSAGE_USAGE));
    }
}
