...
import static seedu.dictionote.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static seedu.dictionote.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static seedu.dictionote.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.dictionote.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.dictionote.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.dictionote.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.dictionote.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static seedu.dictionote.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.dictionote.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.dictionote.logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static seedu.dictionote.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static seedu.dictionote.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static seedu.dictionote.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.dictionote.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
import static seedu.dictionote.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.dictionote.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedContact));
        ...
        // multiple addresses - last dictionote accepted
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, new AddCommand(expectedContactMultipleTags));
    }
