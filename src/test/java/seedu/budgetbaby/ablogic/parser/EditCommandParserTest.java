...
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.budgetbaby.ablogic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
import static seedu.budgetbaby.testutil.TypicalIndexes.INDEX_SECOND_PERSON;
import static seedu.budgetbaby.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_TAG_DESC, Category.MESSAGE_CONSTRAINTS); // invalid tag
        ...
        assertParseFailure(parser, "1" + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + TAG_EMPTY, Category.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_DESC_FRIEND + TAG_EMPTY + TAG_DESC_HUSBAND, Category.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_EMPTY + TAG_DESC_FRIEND + TAG_DESC_HUSBAND, Category.MESSAGE_CONSTRAINTS);
