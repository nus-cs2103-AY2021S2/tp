...
import static seedu.partyplanet.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditCommandParserTest {
    ...
    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditFieldCommand.MESSAGE_USAGE);
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", EditFieldCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditCommand expectedCommand = new EditFieldCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditFieldCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
