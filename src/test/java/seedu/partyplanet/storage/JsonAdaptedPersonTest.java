...
import static seedu.partyplanet.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
import static seedu.partyplanet.testutil.Assert.assertThrows;
import static seedu.partyplanet.testutil.TypicalPersons.BENSON;
...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_BIRTHDAY = "02092021";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_BIRTHDAY, VALID_ADDRESS, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_BIRTHDAY, INVALID_ADDRESS, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
                VALID_EMAIL, VALID_BIRTHDAY, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidRemark_throwsIllegalValueException() {
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_BIRTHDAY, VALID_ADDRESS, INVALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullRemark_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
            VALID_EMAIL, VALID_BIRTHDAY, VALID_ADDRESS, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_BIRTHDAY, VALID_ADDRESS, VALID_REMARK, invalidTags);
