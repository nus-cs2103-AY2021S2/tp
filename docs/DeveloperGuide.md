...
2.  System prompts users for student’s details
...
* 1a. The specified student entry already exists in the system.
...
* 3a. User does not give sufficient to add a student entry.
...
2.  System prompts users for details about the vaccination appointment.
3.  User inputs the respective details.
...
* 3a. User does not give sufficient to add a vaccination appointment.
