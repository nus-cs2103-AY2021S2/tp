...
| `* * *`  | user                                       | find a garment by name                                     | can locate details of a garment without having to go through the entire list             |  
| `* *`    | user                                       | remove a garment from my wardrobe                          | can reflect that a garment has been discarded                                            |  
|  `* *`   | user                                       | easily plan a schedule for what garments to wear           | do not have to waste time deciding at the last minute                                    |
|  `* *`   | user                                       | be reminded on the garments I have not worn                | would not be wearing the same garments all the time                                      |
|  `*`     | user                                       | to see whether certain colours and types of garment match  | will be able to ascertain if the garments match without having to try them on physically |
<br>
