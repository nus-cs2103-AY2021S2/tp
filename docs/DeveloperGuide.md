...
### [Feature] Adding Persons with Optional Fields
The Persons stored inside PartyPlanet should not have any fields to be compulsory except for name. This is to allow 
