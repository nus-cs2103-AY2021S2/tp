...
4.  An average user should be able to get a grasp on the user interface within a few iteration of usage (eg. larger buttons or more recognizable color scheme). 
