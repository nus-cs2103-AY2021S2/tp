...
| `**`    | Regular user                                 | keep track of duplicate orders in case of accidental entering      | I can avoid making more than necessary, wasting time and resources.                          |
...
| `**`    | User                                         | keep track of how many times a user has ordered with the company   | I can give discounts if they have ordered more than x number of times.                       |
...
| `*`      | User who does delivery                       | view a suggested delivery route/delivery plan                      | I don't need to compute dijkstra's algorithm by myself                                       |
...
| `*`      | User who wants to reward loyal customers     | keep track of repeating customers                                  | I can reward loyal customers                                                                 |
...
| `*`      | Advanced user                                | keep track of promo codes and minimum order discounts              | I can give discounts to those who meet the mentioned criteria only.                          |
