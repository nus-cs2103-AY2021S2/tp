...
**Value proposition**: manage delivery workflows and details faster than a typical mouse/GUI driven app for greater
efficiency
...
| `* * *`  | Delivery driver | Find all delivery entries by name, telephone number, address, and date.                    | Get all the deliveries with details containing the name, telephone number, address and date.            |
...
| `* *`    | Delivery driver | Get a statistical summary of my delivery workflow           | understand and plan my current workflow better.                           |
...
**Use case: UC11 - Find all delivery entries by the specified criteria.**
...
* Getting the list of existing delivery entries with details containing the specified keyword related to the given
  criterion.

**MSS**

1. User requests to see all delivery entries with the matching keywords related to a given criteria..
2. Delivery App lists out all existing delivery entries with details containing the specified keyword matching the said
   criterion.
...
* 1b. There are no delivery entries with the matching keyword(s).
    * 1b1. Delivery App informs the User that there are no delivery entries with details containing the specified
      keyword(s).
...
2. **Reliability**:
    - Should be able to hold up to 1000 delivery entries and display all data if requested by the user in less than 5
      seconds
    - Should be able to detect and inform users of duplicate delivery entries and confirm with user if they wish to
      proceed in adding them to the list
...
5. **Flexibility**
    - TimeforWheels should be able to handle as many date format inputs as possible by the user and convert the date
