...
Recall from the User Guide that the `edit` command has the format: `edit INDEX [n/NAME] [S/SIZE] [c/COLOUR] [a/ADDRESS] [d/DESCRIPTION]…​` For this tutorial we will be issuing the command `edit 1 n/Alice Yeoh`.
