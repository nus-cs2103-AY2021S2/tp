...
This command allows users of the ModuleBook application to add optional remarks to people in their address book and edit it if required. The command should have the following format:
...
Simply add the following to [`seedu.address.ui.TaskCard`](https://github.com/se-edu/modulebook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-0c6b6abcfac8c205e075294f25e851fe).
...
:exclamation: You must delete ModuleBook’s storage file located at `/data/modulebook.json` before running it! Not doing so will cause ModuleBook to default to an empty address book!
