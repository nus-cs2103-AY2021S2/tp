...
**A**: Advanced users are welcome to update data directly by editing that data file. AddressBook data are saved as a JSON file `[JAR file location]/data/tutorbuddy.json`.
:exclamation: **Caution:**
