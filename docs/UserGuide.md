...
* The cleaning status field must be provided.

Examples:
*  `edit clean/y 1` Edits the clean status of the 1st residence on the list from `Unclean` to `Clean`.
*  `edit clean/n 2 `  Edits the the clean status of the same residence on the list from `Clean` to `Unclean`.
...
Adds a booking to the specified residence.

Format: `addb n/NAME p/PHONE s/START_TIME e/END_TIME`

Examples:
* `addb n/John p/91234567 s/01-01-2021 e/01-01-2021`
* `addb n/Jane Tan p/6581234567 s/28-12-2021 e/05-01-2022`
...
**Addb** | `add n/NAME_OF_BOOKER p/PHONE_OF_BOOKER s/START_TIME e/END_TIME` <br> e.g., `add n/John p/91234567 s/01-01-2021 e/02-01-2021`
**Clear** | `clear`
**Delete** | `delete INDEX`<br> e.g., `delete 3`
**Deleteb** | `deleteb RESIDENCE_INDEX BOOKING_INDEX` <br> e.g., `deleteb 1 2`
