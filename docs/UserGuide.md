...
Examples:
* `list_session`  followed by `delete 2`  deletes the 2nd session in the TutorBuddy
* `find_session Betsy`  followed by `delete 1`  deletes the 1st session in the results of the find_session command
