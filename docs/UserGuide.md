...
PlanIT is a **desktop app for managing tasks, optimized for use via a Command Line Interface** (CLI). 
Users can quickly add and view their tasks and mark tasks as done.
