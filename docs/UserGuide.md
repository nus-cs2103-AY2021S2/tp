...
* Items with `…​` (i.e an ellipsis) after them can be used multiple times including zero times.<br>
  e.g. `[c/CATEGORY] …​` can be used as `c/Fastfood c/Western c/Fastfood`, or 0 times etc.<br>
