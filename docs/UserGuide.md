...
| `DATE` | `-d`, `--date` | Event | Valid date with a year:{::nomarkdown}<ul><li>Year must be present and a positive integer</li><li>See <code>BIRTHDAY</code> parameter above for available date formats</li></ul>{:/} |
