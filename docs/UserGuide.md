...
| `BIRTHDAY_MONTH` | `-b` /<br>`--birthday` | Contact | Any of the following: :{::nomarkdown}<ul><li>A valid month represented by a string, e.g. `Jan`, `Jun`, `Dec` </li><li>An integer ranging from [0, 12]</li></ul>{:/} |
