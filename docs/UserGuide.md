...
| ---------- | --------------------------------------------------------------------------------------------------------------------------- |
| **Add**    | `add {-p                                                                                                                    | -e} {n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]…​ | n/NAME s/TIME_START e/TIME_END [d/DESCRIPTION]`<br> e.g.,`add -p n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 t/friend t/colleague` |
| **Clear**  | `clear`                                                                                                                     |
