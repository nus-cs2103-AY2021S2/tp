...
--------|------------------
**Add** | `add n/NAME_OF_RESIDENCE a/ADDRESS [clean/[y or n]] [book/[y or n]] [p/LOCK_PASSWORD] [d/BOOKING_DETAILS]]…​` <br> e.g., `add n/Clementi HDB a/459A Clementi Ave 3, #04-257, S121459 clean/n book/y`
**Clear** | `clear`
