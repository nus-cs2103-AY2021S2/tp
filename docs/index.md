...
* If you are interested in using NUS Module Planner, head over to the [_Quick Start_ section of the **User Guide**](UserGuide.html#quick-start).
* If you are interested about developing NUS Module Planner, the [**Developer Guide**](DeveloperGuide.html) is a good place to start.
